...
class BookingController extends Controller
{
    ...
    if('payment_method'=='stripe'){
        ...
        $booking = Booking::create([
            ...
            'num_adults' => $request->num_adults,
            'num_children' => $request->num_children,
            'payment_status' => 'fully_paid', // يمكن تعديل حالة الدفع بحسب الحاجة
            'payment_method' => 'cash', // تعيين طريقة الدفع إلى "cash"
    ...
    public function completePayment(Request $request)
    {
        ...
        if (now()->greaterThan($booking->session_expiry)) {
            return $this->returnErrorMessage('Payment session has expired.', 'E008', 400);
        }
