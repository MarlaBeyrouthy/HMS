...
public function completePayment(Request $request)
{
    ...
    if ($booking && $booking->payment_status == 'Pre_payment') {
        ...
        if ($invoice!=null) {
            ...
            // إعداد المعلومات الموجودة في الفاتورة
            $invoiceInfo = [
            ...
            // إعداد المعلومات الموجودة في الفاتورة إذا كانت موجودة
            $invoiceInfo = null;
        }
        ...
        // إرجاع رسالة بالمعلومات الموجودة في الفاتورة إذا كانت موجودة، وإلا إرجاع رسالة نجاح بدون الفاتورة
