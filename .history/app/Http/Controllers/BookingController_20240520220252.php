...
class BookingController extends Controller
{
    ...
    public function makeBooking(Request $request)
    {
        ...
        try {
            ...
            // تعيين وقت انتهاء الصلاحية للجلسة (مثلاً، 30 دقيقة من الآن)
            $sessionExpiry = now()->addMinutes(30);
            ...
            $booking = Booking::create([
                ...
                'payment_session_id' => $sessionId, // حفظ معرف الجلسة الفريد في الحجز
                'session_expiry' => $sessionExpiry, // حفظ وقت انتهاء صلاحية الجلسة
            ]);
   ...
   public function viewInvoice(Request $request)
{
    ...
    if ($booking->session_expiry < now()) {
        return $this->returnErrorMessage('Session has expired.', 'error', 403);
    }
