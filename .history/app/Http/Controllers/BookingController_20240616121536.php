...
class BookingController extends Controller
{
    ...
    public function makeBooking(Request $request)
    {
        ...
        try {
            ...
            // حساب المبلغ الأساسي للإقامة
$totalBaseAmount =( $basePricePerNight * $numberOfNights)+$taxes;
...
$remainingAmount = $totalBaseAmount - $paidAmount;

// إضافة الضرائب إلى المبالغ
$totalAmountWithTaxes = $totalBaseAmount + $taxes;
$remainingAmountWithTaxes = $remainingAmount + $taxes;
        ...
        'remaining_amount' => $remainingAmountWithTaxes,
        'taxes' => $taxes,
        'invoice_date' => now(),
                ]
            );
