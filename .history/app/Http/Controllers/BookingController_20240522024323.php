...
class BookingController extends Controller
{
    ...
    public function completePayment(Request $request)
    {
        ...
        if ($paymentMethod === 'stripe') {
            // إذا كانت طريقة الدفع المسبق هي cash وحالة الدفع الحالية هي Pre_payment، نقوم بإنشاء جلسة Stripe جديدة
            if ($booking->payment_method === 'cash' && $booking->payment_status === 'Pre_payment') {
                try {
                ...
                return $this->returnErrorMessage('Invalid payment method for completing the payment.', 'E008', 400);
            }
