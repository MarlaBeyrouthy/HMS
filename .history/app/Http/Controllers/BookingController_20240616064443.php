...
public function updateBooking(Request $request)
{
    ...
    // Check if the number of nights increased or the room price increased
    ...
    // Update payment_status to 'pre_payment' if the changes result in additional payment
...
public function viewInvoice(Request $request)
{
    ...
    // Calculate the total amount and taxes
    $totalAmount = $invoice->total_amount;
    $taxes = $totalAmount * $taxRate;

    // Retrieve services associated with the booking
    $services = $booking->services; // Assuming the relationship is defined as services() in the Booking model
    $totalServiceCost = $services->sum('price'); // Assuming each service has a price attribute

    // Update the total amount to include service costs
    $totalAmountWithServices = $totalAmount + $totalServiceCost;
    $totalTaxesWithServices = $totalAmountWithServices * $taxRate;

    // Add the tax amount and services to the invoice object or array
    $invoiceDetails = [
        'total_amount' => $totalAmountWithServices,
        'paid_amount' => $invoice->paid_amount,
        'remaining_amount' => $totalAmountWithServices - $invoice->paid_amount,
        'taxes' => $totalTaxesWithServices,
