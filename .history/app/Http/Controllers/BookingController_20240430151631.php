...
class BookingController extends Controller
{
    ...
    if (!$invoice) {
        return $this->returnErrorMessage('Invoice not found.', 'error', 404);
    }
        ...
        // تحديث مبلغ الدفع المسبق في الفاتورة إلى المبلغ الكلي
        $invoice = $booking->invoices;
        $invoice->paid_amount = $booking->room->roomClass->base_price;
