    ...
    public function completePayment(Request $request)
{
    ...
    $requiredAmount = $remainingAmount - optional($booking->invoice)->paid_amount;
    ...
    return $this->returnData('Payment completed successfully.', [
        ...
        'remaining_amount' => optional($booking->invoice)->remaining_amount,
