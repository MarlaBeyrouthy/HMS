...
class BookingController extends Controller
{
    ...
    public function makeBooking(Request $request, $room_id)
    {
        ...
        // حجز الغرفة
        $booking = $room->bookRoom($user_id, $data['check_in_date'], $data['check_out_date'], $data['num_adults'], $data['num_children'], $data['payment_session_id'], $data['payment_status']);
