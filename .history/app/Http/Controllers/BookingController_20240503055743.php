...
class BookingController extends Controller
{
    ...
    public function handlePaymentSuccess(Request $request)
    {
        ...
        $remainingAmount = ($booking->room->roomClass->base_price * $numberOfDays) - ($booking->room->roomClass->base_price * 0.25);
        
        // حساب المبلغ الكلي
        $totalAmount = ($booking->room->roomClass->base_price * $numberOfDays) + ($booking->room->roomClass->base_price * $taxRate);
