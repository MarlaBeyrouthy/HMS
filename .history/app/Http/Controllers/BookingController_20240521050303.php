...
class BookingController extends Controller
{
    ...
    public function makeBooking(Request $request)
    {
        ...
        try {
            ...
            // تحديث حالة الدفع إذا كانت طريقة الدفع نقدًا
            $booking->payment_status = 'Pending_cash_payment';
            $booking->save();

            // إرجاع رسالة نجاح مع معرف الحجز ومعلومات الفاتورة بدون رابط دفع
            return $this->returnData('Booking created successfully. Please pay in cash upon arrival.', [
                'session_id' => $sessionId,
                'Booking_id' => $booking->id,
                'invoice' => $invoice,
            ], 200);
