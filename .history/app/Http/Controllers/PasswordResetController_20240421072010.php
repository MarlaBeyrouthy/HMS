...
class PasswordResetController extends Controller
{
    ...
    public function sendResetCode(Request $request)
    {
        ...
        return $this->returnSuccessMessage('Verification code sent to your email',200);
    }
    ...
    public function resetPasswordWithCode(Request $request)
    {
        ...
        if (!$resetRecord) {
            return $this->returnErrorMessage('Invalid verification code',404);
        ...
        if ($expiresAt->isPast()) {
            ...
            return $this->returnErrorMessage('Verification code has expired',404);
        }
        ...
        DB::table('password_resets')
          ...
          ->where('code', $request->code)
        ->delete();
        return $this->returnSuccessMessage('Password reset successfully',200);
    }
}
