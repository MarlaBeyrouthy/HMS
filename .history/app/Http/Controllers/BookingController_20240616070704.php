...
public function updateBooking(Request $request)
{
    ...
    // Get the cost of services before update
    $originalServicesCost = $booking->services->sum('price');
    $originalTotalAmount = ($originalBasePricePerNight * $originalNumberOfNights) + $originalServicesCost;
    ...
    // Get the cost of services after update (assuming services remain unchanged)
    $servicesCost = $booking->services->sum('price');
    $totalAmount = ($basePricePerNight * $numberOfNights) + $servicesCost;
    $remainingAmount = $totalAmount - $booking->invoices->paid_amount;
