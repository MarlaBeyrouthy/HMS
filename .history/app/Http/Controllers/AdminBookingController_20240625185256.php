...
class AdminBookingController extends Controller
{
    ...
    public function createBooking(Request $request)
    {
        ...
        try {
            ...
            // Handle Stripe session creation if payment method is 'stripe'
            if ($request->input('payment_method') === 'stripe') {
                // Example: Stripe::setApiKey(...) and Session::create(...)
            }

            return $this->returnData('Booking created successfully.', $booking, 200);
        } catch (\Exception $e) {
