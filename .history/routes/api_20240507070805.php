...
Route::group(["middleware"=>["auth:api"]],function () {
    ...
    Route::post('/request/services/{booking}', [ServiceController::class, 'requestServices']);
    Route::get('/index/services',[ServiceController::class, 'ServiceController@showServices']);
});
